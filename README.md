...
* The test workflow is configured through the test.yml file and is triggered at every push and pull request. It is configured to provide test results in play-mode, edit-mode and standalone-mode. It is made up of 4 steps:
